      ...
      <div className="screen">
        <section className="process" ref={panelRef}>
          ...
          <div className="brand">
            ...
            <div className="brand-word-row">
              <span className="brand-word">MULTISOPLADO</span>
              <span className="brand-suffix">S.A.S.</span>
            </div>
...
.brand{ display:flex; flex-direction:column; align-items:center; position:relative; z-index:2; text-align:center; }
.brand img{ height:56px; display:block; margin-bottom:10px; }
.brand-word-row{ display:flex; align-items:baseline; gap:6px; }
.brand-word{ font-family:'Space Grotesk',sans-serif; font-weight:700; font-size:20px; letter-spacing:0.04em; color:#fff; }
.brand-suffix{ font-family:'Space Grotesk',sans-serif; font-weight:600; font-size:12px; letter-spacing:0.03em; color:rgba(255,255,255,0.7); }
.brand-sub{ font-size:12px; letter-spacing:0.03em; color:rgba(255,255,255,0.45); margin-top:6px; }
